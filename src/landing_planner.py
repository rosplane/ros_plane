...
def publishwaypoints():
	...
	# Overshoot2
	land_p2 = Waypoint()
	land_p2.w[0] = land_point[0] + math.cos(approach_angle*120)
	land_p2.w[1] = land_point[1] + math.sin(approach_angle*120)
	land_p2.w[2] = 0.0
	...
	waypoints = [approach3, approach2, approach1, land, land_p1, land_p2]
